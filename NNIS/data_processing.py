...
def generate_network(network_id, neuron_params, network_params, output_base_dir = False, fill = True):
    """
    ...
    network = Network(network_width, network_height, num_neurons, neuron_params, network_id, fill=fill)
